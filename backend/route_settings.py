...
async def return_manager_page(request: Request, response: Response):
    ...
    return html_templates.TemplateResponse(
        request=request, name="manager.html"
    )
...
async def get_expenses(
    filters: schemas.Filters, request: Request, response: Response
):
...
@main_app.post("/login")
def verify_login(
    user: schemas.UserLogin, response: Response, request: Request
):
...
def create_expense(
    expense: schemas.Expense, request: Request, response: Response
):
...
def create_category(
    category: schemas.Category, response: Response, request: Request
):
...
async def delete_expense(
    expense: schemas.DeleteSpent, request: Request, response: Response
):
...
async def edit_expense(
    expense: schemas.ExpenseEdit, request: Request, response: Response
):
    """Edita uma despesa"""
    utils.autenticate(request, response)
...
async def register_installment(
    installment: schemas.Installment, response: Response, request: Request
):
